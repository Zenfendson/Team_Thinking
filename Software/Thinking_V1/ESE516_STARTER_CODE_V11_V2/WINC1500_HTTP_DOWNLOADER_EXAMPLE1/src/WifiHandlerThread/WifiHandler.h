...
#define GAME_TOPIC_IN "P1_GAME_ESE516_Team16"       // Students to change to an unique identifier for each device! Game Data
#define GAME_TOPIC_OUT "P2_GAME_ESE516_Team16"      // Students to change to an unique identifier for each device! Game Data
...
#define GAME_TOPIC_IN "P2_GAME_ESE516_Team16"       // Students to change to an unique identifier for each device! Game Data
#define GAME_TOPIC_OUT "P1_GAME_ESE516_Team16"      // Students to change to an unique identifier for each device! Game Data
#define IMU_TOPIC "P2_IMU_ESE516_16"            // Students to change to an unique identifier for each device! IMU Data
